...
def print_usage():
    ...
    usage = (
        ...
        "Usage:\n"
        "  python3 fouad.py            # Launch interactive terminal UI\n"
        "  python3 fouad.py --gui      # Launch GUI\n"
        "  python3 fouad.py --help     # Show this help\n"
    )
    print(usage)
if __name__ == "__main__":
    # Basic CLI flags and TTY handling
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--gui":
        ...
        # Avoid prompting for input in non-interactive environments
